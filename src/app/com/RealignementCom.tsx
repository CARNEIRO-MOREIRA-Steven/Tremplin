      ...
      <section className="refonte">
        <h2 className="neon-title" data-neon>Pourquoi faire un réalignement de communication ? <br /><span className="sub">Aussi appelé &apos;refonte de communication&apos;</span></h2>
          ...
          <div className="pourquoi-body">
            <h3>Qu'est-ce qu'une refonte de communication et à quoi sert un plan de communication ?</h3>
            <p>Une refonte de communication permet de remettre de la cohérence dans votre image, vos messages et vos actions. Le plan de communication, lui, sert de feuille de route : il structure ce que vous dites, à qui, comment et à quel moment pour atteindre vos objectifs de manière claire et efficace.</p>
            <p>Et c’est exactement ce que nous proposons à travers cette offre.</p>
            ...
            <p>On pose <strong>un nouveau cadre, une direction, un message qui percute</strong>, et une énergie qui reflète enfin qui tu es aujourd&apos;hui (pas qui tu étais il y a deux ans) et tu vas ainsi attirer à toi les bons clients.</p>
          </div>
      ...
      <div className="col">
        ...
        <div className={`step-block ${visibleCount > 0 ? 'step-visible' : ''}`}>
          ...
          <div className="step-content">
            ...
            <div className="step-body">
              ...
              <p>Cet audit comprend : un entretien, l&apos;analyse de ton parcours client, de tes chiffres, de ta présence en ligne, <strong>de tes canaux de communication</strong>  et de la concurrence.</p>
        ...
        <div className={`step-block ${visibleCount > 4 ? 'step-visible' : ''}`}>
          ...
          <div className="step-content">
            ...
            <div className="step-body">
              <p>On gère tes réseaux pendant 4 semaines : on teste, on mesure, on ajuste <strong>selon tes objectifs.</strong></p>
        ...
        <div className={`step-block ${visibleCount > 3 ? 'step-visible' : ''}`}>
          ...
          <div className="step-content">
            ...
            <div className="step-body">
              ...
              <ul>
                <li>stratégie validée,</li>
                <li>ton <strong> plan de communication,</strong></li>
                <li>nouvel univers graphique,</li>
                <li>objectifs.</li>
              </ul>
