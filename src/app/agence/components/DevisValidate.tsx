...
const DevisValidate = () => {
  return (
    <section id='prochaine-etape'>
        ...
        <ul>
            <li className='first-list'><h3>Fixation du 1er RDV</h3><p>Quelque soit l&apos;offre on commence par un premier RDV, celui qui nous permet d&apos;entrer dans ton projet.</p></li>
