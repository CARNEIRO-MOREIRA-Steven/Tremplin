    ...
    <section className='reviews-container'>
      ...
      <section className='reviews-content'>
        <aside ref={firstRef} className='first-review'>
          <p className='review-title'><span>Stéphanie</span> - Salon de coiffure et SPA pour cheveux</p>
        ...
        <aside ref={secondRef} className='second-review'>
          <p className='review-title'><span>Abby</span> - Wedding planner</p>
        ...
        <aside ref={thirdRef} className='third-review'>
          <p className='review-title'><span>Minh</span> - Entreprise de solutions informatiques sur Paris</p>
