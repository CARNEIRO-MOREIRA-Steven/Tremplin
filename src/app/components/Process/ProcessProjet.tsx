...
const ProcessProjet = () => {
  return (
    <section className='process-container' id='process'>
        <h2 className='neon-title' data-neon>Comment ça se passe quand tu nous confies un projet ?</h2>
        <div className='process-details'>
            <aside>
                <h3><span className='neon-num'>1</span> Prise de contact</h3>
                <p>Tu <a href="/contact">remplis le formulaire</a> et tu nous explique ton projet et tes besoins.</p>
            ...
            <div className=''>
            <img src={TremplinAuBureau.src} alt="une équipe d’expert de communication spécialisés en image de marque" />
            </div>
        </div>
